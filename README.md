...
```
 ...
 > 3) [Обработка сигналов и подсчет информативных характеристик вЭКГ](https://nbviewer.org/github/BMSTU-team/vector_ECG/blob/main/ECG_recording%2BVectorECG_with_analysis.ipynb)
